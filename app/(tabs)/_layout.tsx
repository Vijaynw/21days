      ...
      <Tabs.Screen
        ...
        options={{
          ...
          tabBarIcon: ({ color, focused }) => (
            <IconSymbol size={24} name="house.fill" color={focused ? '#1a1a1a' : color} />
          ),
        }}
      />
        <Tabs.Screen
          ...
          options={{
            title: '',
            tabBarIcon: ({ color, focused }) => (
              <IconSymbol size={24} name="chart.bar.fill" color={focused ? '#1a1a1a' : color} />
            ),
          }}
        />
      <Tabs.Screen
        ...
        options={{
          title: '',
          tabBarIcon: ({ color, focused }) => (
            <IconSymbol size={24} name="person.fill" color={focused ? '#1a1a1a' : color} />
          ),
        }}
      />
      {/* Hidden tabs */}
    ...
    <View style={styles.tabWrapper}>
      <BlurView intensity={35} tint="light" style={styles.tabBackground}>
        {state.routes.map((route, index) => {
          if (!PRIMARY_TABS.includes(route.name as string)) {
            return null;
          }
